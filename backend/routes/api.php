...
Route::prefix('v1')->group(function () {
    ...
    // Story 5.2 & 5.3 : Portail Entreprise (business.sapsap.bf) - Suivi & Exportations
    Route::prefix('business')->middleware('auth:sanctum')->group(function () {
        ...
        Route::get('/campaigns/{id}/export/csv', [\App\Http\Controllers\Api\V1\Business\CampaignBusinessController::class, 'exportCsv']);
        Route::get('/campaigns/{id}/export/excel', [\App\Http\Controllers\Api\V1\Business\CampaignBusinessController::class, 'exportExcel']);
    });
});
